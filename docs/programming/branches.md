...
|オペコード|正式名称|説明|
|-|-|-|
|**CMP**|Compare A|アキュムレータの数値と与えられた数値を比較する|
...
|オペコード|正式名称|説明|
|-|-|-|
|**BCS**|Branch if carry set|ロードされた数値が与えられた数値以上の場合（つまり、キャリーフラグがセットされている場合）に分岐する|
|**BCC**|Branch if carry clear|ロードされた数値が与えられた数値未満の場合（つまり、キャリーフラグがクリアされている場合）に分岐する|
